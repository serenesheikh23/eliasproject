...
<head>
  ...
  <title>404 — Page Not Found · Marketly</title>
  <style>
    /* ── Reset ─────────────────────────────────────── */
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    /* ── Accent palette ───────────────────────────── */
    .accent{color:#10B981}
    .accent-dim{color:rgba(16,185,129,.4)}
    /* ── Layout ───────────────────────────────────── */
    ...
    /* ── Typography ────────────────────────────────── */
    .code{font-size:clamp(5rem,20vw,9rem);font-weight:800;letter-spacing:-.05em;line-height:1;background:linear-gradient(135deg,#10B981 0%,#059669 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
    .heading{font-size:clamp(1.5rem,4vw,2.25rem);font-weight:700;color:#F8FAFC;margin-top:.75rem;letter-spacing:-.02em}
    .body{font-size:1rem;color:#94A3B8;max-width:480px;margin:1rem auto 0;line-height:1.75}
    /* ── Actions ──────────────────────────────────── */
    ...
    .orb-1{width:400px;height:400px;background:rgba(16,185,129,.08);top:-100px;right:-100px}
    .orb-2{width:300px;height:300px;background:rgba(16,185,129,.05);bottom:-80px;left:-80px}
    /* ── Divider ──────────────────────────────────── */
    .divider{width:60px;height:2px;background:linear-gradient(90deg,#10B981,#059669);border-radius:1px;margin:1.5rem auto 0}
    /* ── Logo ─────────────────────────────────────── */
...
<body>
  ...
  <div class="page">
    ...
    <p class="accent text-sm font-semibold tracking-widest uppercase mb-2">404</p>
